...
function App() {
    ...
    const [helloFromSmartContract, setHelloFromSmartContract] = useState(null);
    ...
    const getHelloFromSmartContract = () => {
        debugger
        let simpleStorageContract = new web3Reference.eth.Contract(SimpleStorageABI, selectedContractAddress)
        simpleStorageContract
            .methods
            ...
            .call()
            .then((data) => {
                setHelloFromSmartContract(data)
            })
    }
        ...
        <div className="flexgrid mlm dib">
            { web3Reference !== null ? <div>
                ...
                <div style={{"marginLeft": "30rem"}} className={"mtl"}>
                    ...
                    <button className={"btn btn--green mlm"} onClick={() => getHelloFromSmartContract()}> Get Hello
                    </button>

                    <span className={"mlm"}>{valueFromSmartContract}</span>
                    <span className={"mlm"}>{helloFromSmartContract}</span>
                    <br/>
